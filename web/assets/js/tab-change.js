;(function ($, window, document, undefined) {
  ...
  var Plugin = function (elem, options) {
    ...
    this.$tab_list = this.$wrapper.find('.tab-title').find('.tab-item');
  ...
  Plugin.prototype = {
    ...
    tabInital: function () { // 初始化当前显示
      ...
      this.$tab_list.removeClass('active-tab');
      this.$tab_list.eq(curNum).addClass('active-tab');
    ...
    changeTab: function (index) { // 选项卡切换
      this.$tab_list.removeClass('active-tab');
      this.$tab_list.eq(index).addClass('active-tab');
